...
# 2. Create the 'feynman' user with the specific UID/GID
...
# 4. Handle Entrypoint
# Copy with ownership set to feynman so they can execute it
...
# Install feynman CLI
RUN npm install -g @companion-ai/feynman
